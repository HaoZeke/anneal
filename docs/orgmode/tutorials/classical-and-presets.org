...
.. admonition:: Reference
   ...
   Generalized-SA families to the five slots are documented in the reference
   paper (see [[file:../used_by.org][used_by]]) and in the reproducibility package
   (SymPy witnesses of the four limit cases).
#+end_export
