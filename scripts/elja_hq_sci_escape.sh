#!/usr/bin/env bash
# Recommended remesure: featomic leftover + stall tabu + Lanczos climb.
# No random redraw on tabu. Does not touch HQ job 2 or job 87.
#   LJ38: 4e5 x 72
#   LJ55: 1e6 x 48
#   LJ75: 4e6 x 48
set -euo pipefail
ROOT=${LJ_ROOT:-$HOME/anneal-build}
OUT=${LJ_OUT:-$HOME/ljwork/hq-sci-escape}
