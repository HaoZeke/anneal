...
pub use occupancy::{
    ...
    is_occupancy_leave_action, leave_shot_accepted, leftover_lambda, leftover_sat_dwell,
    lens_ring_displacement, occupancy_complete, occupancy_complete_at, occupancy_ei_exhausted,
