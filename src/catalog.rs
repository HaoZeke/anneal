...
pub use occupancy::{
    ...
    OccupancyCertificate, OccupancyFes, OccupancyLeaveAdopt, OccupancyLeaveTarget, PackingRole,
    ...
    occupancy_fes, occupancy_fes_delta, occupancy_fes_from_histograms, occupancy_landfold_floor,
