...
pub use occupancy::{
    ...
    leftover_birth_probability, leftover_esty_stable, leftover_esty_upper, leftover_esty_var,
    leftover_hatch_stable,
    leftover_lambda, leftover_sat_dwell, lens_ring_displacement, occupancy_book_holes,
    ...
    occupancy_leave_adopt, occupancy_leave_by_birth, occupancy_leave_by_ei, occupancy_leave_new_class,
...
pub use packing::{
    ...
    different_decaf_family, different_packing_family, fivefold_apart, leaves_packing,
    leftover_arrivals_saturated,
    ...
    FIVEFOLD_COLLAPSE_CEILING, FIVEFOLD_COLLAPSE_WINDOW, FIVEFOLD_FUNNEL_FLOOR, FIVEFOLD_HOLD,
    SEAM_BIN_WIDTH,
    SEAM_BINS, SEAM_BURST_SHOTS, SEAM_DOORWAY_GAP, SEAM_DOORWAY_WINDOW,
