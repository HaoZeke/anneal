...
pub use occupancy::{
    ...
    leftover_esty_stable, leftover_esty_upper, leftover_esty_var, leftover_sat_dwell,
    lens_ring_displacement, occupancy_compact, occupancy_complete, occupancy_leave_new_class,
