...
pub use occupancy::{
    ...
    OccupancyCompact, OccupancyFes, OccupancyFesError, OccupancyLandfoldPoint, OccupancyLeaveAdopt,
    OccupancyLeaveTarget, PackingRole, assign_interfaces, in_interface_ensemble, interface_ladder,
    is_occupancy_leave_action, leave_shot_accepted, leftover_esty_stable, leftover_esty_upper,
    leftover_esty_var, leftover_hatch_stable, leftover_lambda, leftover_sat_dwell,
    lens_ring_displacement, occupancy_book_holes, occupancy_compact, occupancy_complete,
    ...
    occupancy_map_fold, OccupancyFold,
    occupancy_leave_new_class, occupancy_leave_target, occupancy_map_floor,
