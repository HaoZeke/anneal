...
pub use occupancy::{
    ...
    OCCUPANCY_EI_MIN_OBS, OCCUPANCY_SEAM_CONDUCTANCE, OccupancyCertificate, OccupancyCompact,
    OccupancyFes, OccupancyFesError, OccupancyLeaveAdopt, OccupancyLeaveTarget, PackingRole,
    ...
    occupancy_archive_hole_is_fivefold, occupancy_leave_adopt, occupancy_leave_new_class,
    ...
    occupancy_ring_profile, occupancy_ring_split, packing_role, promote_one_sided,
