...
//!
//! Sampling uses the standard Student-t / q-Gaussian representation: draw
//! z from N(0, I_d), draw g from Gamma(alpha, 1) with
//! alpha = 1/(q-1) - d/2, then set p = z * sqrt(1 / ((q-1) * g)).
