...
def gpmd(counter, low, high, dim, grad, rng, anchor=None):
    """Gap-Proportional Metropolis Descent (derived: T = ½ gap / d)."""
    del dim
    import anneal
...
def amsa(counter, low, high, dim, grad, rng, anchor=None):
